#!/usr/bin/env python3
"""
Recupero codici sconto Sarenza da shopilo.it
Sursa: https://shopilo.it/negozi/sarenza.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/sarenza.it"
STORE_NAME = "Sarenza"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Sarenza da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-sarenza)"
    }
    try:
